                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-label-group position-relative has-icon-left">
                                    <input readonly type="text" class="form-control" value="{{$item->quantity}}" placeholder="Quantity">
                                    <div class="form-control-position">
                                        <i class="feather icon-feather"></i>
                                    </div>
                                    <label for="email-id-floating-icon">Quantity</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-label-group position-relative has-icon-left">
                            ...
                            <div class="col-12">
                                <div class="form-label-group position-relative has-icon-left">
                                    <input readonly type="text" class="form-control" value="{{$item->start_count}}" placeholder="Start Count">
                                    <div class="form-control-position">
                                        <i class="feather icon-dollar-sign"></i>
                                    </div>
                                    <label for="email-id-floating-icon">Start Count</label>

                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-label-group position-relative has-icon-left">
                                    <input readonly type="text" class="form-control" value="{{$item->remains}}" placeholder="Remains">
                                    <div class="form-control-position">
                                        <i class="feather icon-dollar-sign"></i>
                                    </div>
                                    <label for="email-id-floating-icon">Remains</label>
