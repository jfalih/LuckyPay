                ...
                <div class="col-sm-4">
                    <div class="card">
                      <div class="card-content">
                        <div class="card-body">
                          <img class="card-img img-fluid mb-1" src={{$site->url.'/storage/'.$site->image}} alt={{$site->name}}>
                          <h5 class="mt-1">{{Auth::user()->name}}</h5>
                          <p class="card-text">{{Auth::user()->level}}</p>
                          <hr class="my-1">
                          <div class="d-flex justify-content-between mt-2">
                            <div class="float-left">
                              <p class="font-medium-2 mb-0">Rp{{number_format(Auth::user()->balance,2,',','.')}}</p>
                              <p class="">Sisa Saldo</p>
                            </div>
                            <div class="float-right">
                              <p class="font-medium-2 mb-0">{{$total_transaksi}}</p>
                              <p class="">Total Transaksi</p>
                            </div>
                          </div>
                        </div>
                        <div class="d-md-none p-1">
                          <a href="{{$site->url.'/history/deposit'}}" class="btn btn-block btn-primary mb-50">Mutasi Saldo</a>
                          <a href="{{$site->url.'/point'}}" class="btn btn-block btn-primary mb-50">{{Auth::user()->point}} - Tukar Point</a>
                          <a href="{{$site->url.'/setting/profile'}}" class="btn btn-block btn-primary mb-50">Setting Profile</a>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="tab-content pt-1">
                            ...
                            <div class="tab-pane" id="api-fill" role="tabpanel" aria-labelledby="api-tab-fill">
                                 <form method="POST" action="{{route('change_ip')}}">
                                     @csrf
                                <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="text" class="form-control" value="{{$user->ip_static}}" name="static_ip" placeholder="0.0.0.0" aria-describedby="basic-addon1">
                                        </div>
                                    </fieldset>
                                    </div>
                                </div>
